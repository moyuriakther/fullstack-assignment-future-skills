  ...
  filter() {
    ...
    if (
      ...
      if (isNaN(minPrice) || isNaN(maxPrice)) {
        throw new Error(
          'Invalid price values: minPrice and maxPrice must be numbers',
        );
      }
      queryObj = {
        ...queryObj,
    ...
    } else if (this.query.minPrice !== undefined) {
      queryObj = { ...queryObj, price: { $gte: Number(this.query.minPrice) } };
    } else if (this.query.maxPrice !== undefined) {
      queryObj = { ...queryObj, price: { $lte: Number(this.query.maxPrice) } };
    }
